...
const register = (event) => {
	...
	const confirm_password = document.getElementById(
		_ui.form_fields.confirm_password
	);
	...
	if (password.value === "") {
		...
		setValidation(
			password,
			false,
			"La contraseña debe tener entre 8 y 15 caracteres, al menos una letra mayúscula, una minúscula, un número y un carácter especial"
		);
	} else {
